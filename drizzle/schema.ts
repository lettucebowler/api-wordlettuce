import { sqliteTable, AnySQLiteColumn, index, primaryKey, integer, foreignKey, text, uniqueIndex, numeric } from "drizzle-orm/sqlite-core"
...
(table) => {
	return {
		...
		pk0: primaryKey({ columns: [table.gamenum, table.userId], name: "game_results_gamenum_user_id_pk"})
	}
});
